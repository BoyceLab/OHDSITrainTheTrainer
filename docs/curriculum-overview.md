...
> **Timebox:** Each live session is 4 hours (with one 10–15 minute break).  
> **Homework:** Each week concludes with an approximately 1-hour assignment to reinforce concepts and prepare for the next module.
...
**Homework Assignment (~1h):**  
Recreate one concept set from class using a different condition (e.g., diabetes, hypertension). Export the concept IDs and prepare to share your process during the start of Day 2.
...
**Homework Assignment (~1h):**  
Run a DQD or Achilles report on your training CDM or sample data. Note three data quality issues or warnings that could impact cohort building. Be ready to discuss findings in Day 3.
...
**Homework Assignment (~1h):**  
Refine your cohort definition from Lab 3 by adding an inclusion criterion or exclusion rule. Re-run characterization and compare outputs to your original cohort.
...
**Homework Assignment (~1h):**  
Using your Day 3 cohort, design and run a SEARCH extraction for patient-level data. Document your query logic and output summary for discussion on Day 5.
...
**Homework Assignment (~1h):**  
Identify one pathway anomaly or insight from your lab results. Prepare a brief (3–5 slide) summary to share during the Day 6 session.
...
**Homework Assignment (~1h):**  
Complete the HADES workflow on a small cohort of your choice and submit summary diagnostics. Discuss lessons learned and troubleshooting steps during wrap-up.
